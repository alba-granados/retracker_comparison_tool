...
% imagesPath: Paths of the images
% description
% Outputs
%   
% Comments:
...
function lla2kmlWaveforms_noimage(filename,name_data,lat,lon,alt, mode)
...
% if(~imagesPath)
%    disp('No Path Waveforms ');
%    return;
% end
%WaveformsPath   =   dir(imagesPath);
...
%             end
            ...
            fprintf(fidKML,'                   <altitudeMode>absolute</altitudeMode>\n');
            ...
            fprintf(fidKML,'                   </LabelStyle>\n');      
            fprintf(fidKML,'               </Style>\n');
            fprintf(fidKML,sprintf('               <description><![CDATA[Lat=%d; Lon=%d Alt=%d]]></description>\n',lat(iPoint),lon(iPoint),alt(iPoint)));
    ...
    fprintf(fidKML,'       <name>Surfaces</name>\n');
    ...
    fprintf(fidKML,'   <name><![CDATA[%s]]></name>\n',name_data);
