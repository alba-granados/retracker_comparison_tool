function [ax,h]=suplabel(text,whichLabel,supAxes,varargin)
...
% %added by EM 20.03.2018
% p = inputParser;
% p.addParamValue('interpreter_title','none',@(x)ischar(x));
% p.parse(varargin{:});
% interpreter_title=char(p.Results.interpreter_title);
% clear p;
