...
%--------------------------------------------------------------------------
cnf_p.antenna_compensation_al = 0;
...
%------------------------------------------------------------------
cnf_p.filter_land       =  0;
cnf_p.filter_land_type  =  '';

%----------------------------------------------------------------------
%------------------ Discarding samples begin/end waveform -------------
%----------------------------------------------------------------------
cnf_p.wvfm_discard_samples       = 0;
cnf_p.wvfm_discard_samples_begin = 12;
cnf_p.wvfm_discard_samples_end   = 14;
...
% ------------- external noise ----------------------------------------
cnf_p.external_Thn_value =   0.00245;              %in case of using an external source when THn_flag set to
...
%--------------------------------------------------------------------------
% Atmospheric attenuation correction
cnf_p.atm_att_correction_flag = 0;


%--------------------------------------------------------------------------
%------------------------OUTPUT PRODUCT -----------------------------------
%--------------------------------------------------------------------------
cnf_p.Product_type='LAN';
cnf_p.output_product_format='nc';
cnf_p.nc_format_type = 'default';
cnf_p.nc_name_surface_height='sh';
